        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-slate-500 mt-2 max-w-md mx-auto">
              Bulk promotional email to opted-in companies will come online once the BullMQ email
              worker is shipped in the backend.
            </p>
            <div className="mt-6 inline-flex items-center gap-2 text-xs text-slate-400">
              <Mail className="h-3.5 w-3.5" />
              Endpoint pending: <code className="font-mono">POST /api/admin/email/bulk</code>
            </div>
          </CardContent>
        </Card>
      </div>
