        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-50 border border-primary-100 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-sm text-primary-700 font-medium">Now available worldwide</span>
            </div>
      ...
      <section className="py-20 bg-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-slate-500 mt-4 max-w-md mx-auto">
            The simplest way for fuel stations and shops to track customer purchases.
          </p>
