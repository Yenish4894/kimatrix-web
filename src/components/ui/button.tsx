...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 font-medium rounded-md cursor-pointer transition-[color,background-color,border-color,box-shadow,transform] duration-150 ease-out disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 active:scale-[0.98]",
  {
    variants: {
      variant: {
        primary:
        ...
        accent:
          "text-white bg-accent-700 shadow-[0_1px_2px_rgba(249,115,22,0.3),inset_0_1px_0_rgba(255,255,255,0.2)] hover:bg-accent-800 hover:shadow-[0_2px_10px_rgba(249,115,22,0.4),inset_0_1px_0_rgba(255,255,255,0.2)] active:bg-accent-900 active:shadow-[inset_0_1px_2px_rgba(0,0,0,0.15)]",
