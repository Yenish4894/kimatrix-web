  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 mb-4">
        ...
        <div className="flex items-center h-11 w-full sm:w-auto rounded-md border border-slate-200 bg-white divide-x divide-slate-200 overflow-hidden focus-within:border-primary-500 focus-within:ring-[3px] focus-within:ring-primary-500/15">
