...
export function DashboardShell({ children, title, requiredRole }: Readonly<DashboardShellProps>) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-50 focus:bg-primary-700 focus:text-white focus:px-4 focus:py-2 focus:rounded-md focus:shadow-lg"
      >
